      ...
      <ScrollView bg="#FEF2CD">
        ...
        >
          ...
          <InputForm
            ...
            placeholder="CPF"
            InputLeftElement={
              <Icon as={<User color={colors.text[50]} />} ml={2} />
            }
          ...
          <InputForm
            ...
            InputLeftElement={
              <Icon as={<Key color={colors.text[400]} />} ml={2} />
            }
            ...
            InputRightElement={
              <Pressable onPress={() => setShowConfirm(!showConfirm)}>
                <Icon
                  as={
                    showConfirm ? (
                      <Eye size={26} color={colors.text[400]} />
                    ) : (
                      <EyeSlash size={26} color={colors.text[400]} />
                    )
                  }
                  size={5}
                  mr="4"
          ...
          >
            {errors.signChoice && errors.signChoice.message}
          </FormControl.Label>
